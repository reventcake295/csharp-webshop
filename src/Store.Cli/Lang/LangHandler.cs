...
public static class LangHandler
{
    ...
    static LangHandler()
    {
        ...
        _loadLangMap(App.GetSettings().DefaultLang);
    }
    
    public static string GetLangString(string key) => _LangMap.TryGetValue(key, out LangCollection? result) ? result.GetString() : "";

    public static string GetLangGroupString(string key, StringType stringType) => _LangMap.TryGetValue(key, out LangCollection? result) ? result.GetGroupString(stringType) : "";
    ...
    /// <returns></returns>
    public static string GetSpecificOrDefaultString(string key, StringType stringType)
    {
